...
import torch
import joblib
from CNN_CNN_LSTM_process_data import dataset, create_char2idx_dict, create_tag2idx_dict, create_word2idx_dict, new_custom_collate_fn, budget_limit, augment_pretrained_embedding
from CNN_CNN_LSTM_architecture import CNN_CNN_LSTM

class CNN_CNN_LSTM_Flow(FlowSpec):
	...
	def fit(self):
		...
		model = CNN_CNN_LSTM(
			...
			word_out_channels=self.word_out_channels,
			word_conv_layers = self.word_conv_layers,
