...
class CRFContratos():
    ...
    def _get_features(self, sentence):
        ...
        for i in range(len(sentence)):
            ...
            word_before = self.get_base_feat(word_before)
            word_before2 = self.get_base_feat(word_before2)
            word_before3 = self.get_base_feat(word_before3)
            word_after = self.get_base_feat(word_after)
            word_after2 = self.get_base_feat(word_after2)
            word_after3 = self.get_base_feat(word_after3)
