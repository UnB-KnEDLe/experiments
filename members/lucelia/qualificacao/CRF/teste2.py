...
#train_sents =  list(nltk.corpus.reader.conll.ConllCorpusReader.iob_sents('/home/82068895153/POS/skweak/data/conll2003_dataset', 'eng.train'))
corpus =  nltk.corpus.reader.conll.ConllCorpusReader('/home/82068895153/POS/skweak/data/conll2003_dataset', 'eng.train', ['words', 'pos', 'ignore', 'chunk'])
train_sents = corpus.iob_sents()
