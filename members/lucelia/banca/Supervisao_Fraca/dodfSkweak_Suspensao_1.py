...
class SkweakSuspensao(LabelFunctionsSuspensao):
    ...
    def apply_label_functions(self):
        ...
        detec_modalidade = skweak.heuristics.FunctionAnnotator(
            "detec_modalidade", self.modalidade_)
        ...
        ''' 
        detec_numero_licitacao = skweak.heuristics.FunctionAnnotator(
            "detec_numero_licitacao", self.numero_licitacao_)
        ...
        #    skweak.utils.display_entities(self.docs[i], all_fun)
    ...
    def list_spans_specific(self, x):
        ...
        parametros:
            x: inteiro representando a posicao do doc no vetor de contratos da base de dados
        '''
