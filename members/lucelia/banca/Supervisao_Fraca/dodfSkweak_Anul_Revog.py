...
class SkweakAnulRevog(LabelFunctionsAnulRevog):
    ...
    def train_HMM_Dodf(self):
        ...
        '''
        model = skweak.aggregation.HMM("hmm", ["processo_gdf", "modalidade_licitacao", "numero_licitacao", "data_escrito"], sequence_labelling=True)
    ...
    def get_hmm_dataframe(self):
        ...
        for doc in doc_bin.get_docs(nlp.vocab):
            aux = {"processo_gdf": "", "modalidade_licitacao": "", "numero_licitacao": "","data_escrito": "", "text": "", "labels": ""}
