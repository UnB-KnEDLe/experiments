...
#EXTRATO DO CONTRATO No 11/2019
...
class SkweakAditamento(LabelFunctionsAditamento):
    ...
    def __init__(self, dados):
        ...
        self.df = pd.DataFrame(columns=["numero_contrato", "processo_gdf", "data_assinatura_contrato", "text", "labels"])
...
# 12/09/2022 b_data_assinatura = Sim = b_assinatura 
        ...
        model = skweak.aggregation.HMM("hmm", ["numero_contrato", "processo_gdf", "data_assinatura_contrato"], sequence_labelling=True)
    ...
    def get_hmm_dataframe(self):
        ...
        for doc in doc_bin.get_docs(nlp.vocab):
            aux = {"numero_contrato": "", "processo_gdf": "", "data_assinatura_contrato": "", "text": "", "labels": ""}
